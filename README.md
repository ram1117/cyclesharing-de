...
# 📖 CycleShare - DE <a name="about-project"></a>


**CycleShare - DE** is React Capstone project at Microverse. It's a SPA, that provides bike sharing services across German cities, providers, bike station locations and bike availability. The data is obtained from [CityBikes API](https://api.citybik.es/v2/). The app is primary developed for mobile screens. I used React for UI components and Redux for state management.
...
```sh
  cd <desired-folder>
  git clone https://github.com/ram1117/cyclesharing-de.git
  cd cyclesharing-de
```
...
Please log any bugs or issues in [issues page](https://github.com/ram1117/cyclesharing-de/issues).
...
If you like this project, please give a Start to the [github repo](https://github.com/ram1117/cyclesharing-de/)
...
- **How to report bugs?**
  ...
  - Please raise [github issue](https://github.com/ram1117/cyclesharing-de/issues) with more details about the bug.
